#!/bin/bash
#This is the killswitch that will save or destroy all computers!

if [[ -f green ]]
then
echo "Incorrect wire cut. Now launching virus!"
...
say "2"
say "1"
echo "Hmm. Guess nothing happened. Payload failed to launch, try cutting a different wire"
else
